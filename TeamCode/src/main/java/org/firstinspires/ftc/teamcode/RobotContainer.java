...
public class RobotContainer {
    ...
    public void configureButtonBindings() {
        ...
        driverController.x().onTrue(Pivot.setPosition(subsystems.pivot(), () -> PivotConstants.SHOOT));
        driverController.y().onTrue(Pivot.setPosition(subsystems.pivot(), () -> PivotConstants.CLIMB));
        driverController.b().onTrue(Pivot.setPosition(subsystems.pivot(), () -> PivotConstants.MED));
        driverController.rightTrigger().onTrue(Intake.setPower(subsystems.intake(), () -> IntakeConstants.INTAKE_POWER))
                .onFalse(Intake.setPower(subsystems.intake(), () -> 0.0));
