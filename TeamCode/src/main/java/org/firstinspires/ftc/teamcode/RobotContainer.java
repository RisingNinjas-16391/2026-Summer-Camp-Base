...
public class RobotContainer {
    ...
    public void configureButtonBindings() {
        ...
        driverController.a().onTrue(Pivot.setPosition(subsystems.pivot(),() -> PivotConstants.CLIMB));
        driverController.b().onTrue(Pivot.setPosition(subsystems.pivot(),() -> PivotConstants.FEED));
        driverController.x().onTrue(Pivot.setPosition(subsystems.pivot(),() -> PivotConstants.CONE));
