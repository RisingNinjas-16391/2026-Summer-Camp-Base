...
public class RobotContainer {
    ...
    public void configureButtonBindings() {
        ...
        driverController.x().onTrue(Pivot.setPosition(pivot, () -> PivotConstants.CONE));

        driverController.b().onTrue(Pivot.setPosition(pivot, () -> PivotConstants.CLIMB));
        ...
        driverController.rightTrigger().onTrue(Intake.setPower(intake, () -> IntakeConstants.INTAKE_POWER))
                .onFalse(Intake.setPower(intake, 0));
        driverController.rightBumper().onTrue(Intake.setPower(intake, () -> IntakeConstants.CONE_POWER))
                .onFalse(Intake.setPower(intake, 0));
