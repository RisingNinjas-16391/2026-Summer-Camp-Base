...
public class RobotContainer {
    ...
    public void configureButtonBindings() {
       ...
       // driverController.b().onTrue(Intake.setPower(intake, () -> IntakeConstants.OUTTAKE_POWER));
        ...
        driverController.b().onTrue(Pivot.setPosition(pivot, () -> PivotConstants.HIGH));

        driverController.a().onTrue(Pivot.setPosition(pivot, () -> PivotConstants.FEED));

        driverController.x().onTrue(Pivot.setPosition(pivot, () -> PivotConstants.ICECREAM));

        driverController.y().onTrue(Pivot.setPosition(pivot, () -> PivotConstants.CLIMB));

        driverController.leftBumper().onTrue(Pivot.setPosition(pivot, () -> PivotConstants.LOW));

        driverController.leftTrigger().onTrue(Intake.setPower(intake, () -> IntakeConstants.INTAKE_POWER))
                .onFalse(Intake.setPower(intake, () -> 0));

        driverController.rightTrigger().onTrue(Intake.setPower(intake, () -> IntakeConstants.OUTTAKE_POWER))
                .onFalse(Intake.setPower(intake, () -> 0));
