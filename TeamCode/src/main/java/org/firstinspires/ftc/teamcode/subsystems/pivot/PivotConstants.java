...
public class PivotConstants {
    ...
    public static double ticksToRotations = (1 / 28.0) * (1 / 50.9) * (1 / 2.0) * (1 / 5.0);

    public static double setpoint = -0.25;

    public static double initialPosition = -0.12;

    public static double FEED = -0.12;
    public static double LEVEL1 = 0.15;
    public static double LEVEL2 = 0.2;

    public static double LEVEL3 = 0.2;

    public static double LEVEL4 = 0.2;

    public static double LEVEL5 = 0.2;
